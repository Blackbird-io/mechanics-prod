...
class SummaryMaker:
    ...
    def flush(self):
        ...
        if len(timeline_summary):
            ...
            full = (
                target_fins.periods_used == self.complete_periods[self.onkey]
            )
