    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary',
                 json_field.fields.JSONField(default='null', help_text='Enter a valid JSON object', null=True)),
                ('business_name', models.CharField(null=True, max_length=256)),
                ('tags', json_field.fields.JSONField(default='null', help_text='Enter a valid JSON object', null=True)),
