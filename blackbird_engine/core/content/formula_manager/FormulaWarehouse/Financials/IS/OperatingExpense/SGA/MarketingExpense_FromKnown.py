...
#Blackbird Engine
#Module: FW.Financials.IS.OpEx.SGA.MarketingExpense_FromKnown
"""

Content module for a formula that computes monthly marketing expense from an
...
name = "inflation-adjusted marketing expense from known start."
...
required_data = ["base_annual_marketing",
                 "annual_inflation",
                 "ref_year"]
...
def func(line, business_unit, data, driver_signature):
    ...
    #
    monthly_comp = data["base_annual_marketing"]/12 * inflation_multiplier
    #
