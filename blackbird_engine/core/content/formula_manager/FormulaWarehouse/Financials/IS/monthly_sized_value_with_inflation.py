...
name = "inflation-adjusted monthly value multiplied by unit size."
...
def func(line, business_unit, data, driver_signature):
    ...
    Function sets line to the specified monthly expense, multiplied by unit size
    and the compounded inflation since ref_year. Function then applies
    ...
    #
    value = data["fixed_monthly_value"] * business_unit.size * inflation_multiplier
