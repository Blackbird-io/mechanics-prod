...
name = "inflation-adjusted monthly value."
...
required_data = ["base_monthly_value",
                 "annual_inflation",
                 "ref_year"]
...
def func(line, business_unit, data, driver_signature):
    ...
    Function computes monthly value adjusted for inflation. Function then sets
    line value to monthly result and tags the line with descriptive tags. 
    ...
    #
    monthly_value = data["base_monthly_value"] * inflation_multiplier
    #
    line.setValue(monthly_value, driver_signature)
