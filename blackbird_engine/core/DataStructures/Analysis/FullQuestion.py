...
from DataStructures.Platform import ID
from DataStructures.Platform import Tags

from .InputElements import Binary
from .InputElements import Bool
from .InputElements import Choice
from .InputElements import Date
from .InputElements import DateRange
from .InputElements import Number
from .InputElements import NumberRange
from .InputElements import Text
from .InputElements import Time
from .InputElements import TimeRange
...
class FullQuestion:
    ...
    _types["binary"]["klass"] = Binary.BinaryInput
    _types["bool"]["klass"] = Bool.BoolInput
    _types["choice"]["klass"] = Choice.ChoiceInput
    _types["date"]["klass"] = Date.DateInput
    _types["date-range"]["klass"] = DateRange.DateRangeInput
    _types["number"]["klass"] = Number.NumberInput
    _types["number-range"]["klass"] = NumberRange.NumberRangeInput
    _types["time"]["klass"] = Time.TimeInput
    _types["time-range"]["klass"]= TimeRange.TimeRangeInput
    _types["text"]["klass"] = Text.TextInput
