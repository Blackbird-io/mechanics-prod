...
#functions
def run_test_do(bLocation, test, retainState = False, log = False, timer = False):
    """
...
def run_test_check(bLocation, test, result, log = False, timer = False):
    """
