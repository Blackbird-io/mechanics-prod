#Answer Script: software_5

#Company charges enough per subscriber to make a profit and pays 0 bonuses.
#Tracks real responses for AIQ.
...
answers[q1] = [{"response" : "Indiana Soft Works"}]
answers[q2] = [{"response" : "software"}]
answers[q3] = [{"response" : "Steve"}]
