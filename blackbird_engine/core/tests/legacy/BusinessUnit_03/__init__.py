...
#Module: (Basic) BusinessUnit_03.__init__
...
Task loads ModelComponents,[makes some lineitems, checks partOf, checks 3st]. 
...
def check(result,useRefPath = False,refPath=None):
    ...
    if useRefPath:
        ...
        dRefPath = r"c:\blackbird\engine\builds\122914reference"
        if not refPath:
            refPath = dRefPath
