...
task loads a model with one filled out period and extrapolates that period
1, 2, and 3 years forward and back. grader checks that mechanics work correctly
at a high level. 
